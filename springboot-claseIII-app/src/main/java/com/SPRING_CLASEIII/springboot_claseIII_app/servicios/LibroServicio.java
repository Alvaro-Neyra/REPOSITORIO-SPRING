...
import com.SPRING_CLASEIII.springboot_claseIII_app.entidades.Libro;
...
import com.SPRING_CLASEIII.springboot_claseIII_app.repositorios.RepositorioLibro;
...
public class LibroServicio {
    ...
    @Transactional
    public void crearLibro(String titulo, int ejemplares, UUID idAutor, UUID idEditorial) throws MiException {
        validar(titulo);
        validar(ejemplares);
        validar(idAutor);
        validar(idEditorial);
    ...
    @Transactional
    public void modificarLibro(String titulo, int ejemplares, UUID idAutor, UUID idEditorial, Long isbn) throws MiException {
        validar(titulo);
        validar(ejemplares);
        validar(idAutor);
        validar(idEditorial);
    ...
    private void validar(int numero) throws MiException {
        if (numero <= 0) {
